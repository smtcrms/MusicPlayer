...
import code.name.monkey.retromusic.ui.fragments.mainactivity.GenresFragment;
...
public class MusicLibraryPagerAdapter extends FragmentPagerAdapter {
    ...
    public MusicLibraryPagerAdapter(@NonNull final Context context, final @NonNull FragmentManager fragmentManager) {
